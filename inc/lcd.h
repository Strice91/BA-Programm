 ...
 #define LCD_H
/*************************************************************************
 Title	:   C include file for the HD44780U LCD library (lcd.c)  V2.0
 Author:    Peter Fleury <pfleury@gmx.ch>  http://jump.to/fleury
			Werner Freytag, kleine Ergänzungen
 ...
 *  Zur Anschlussdefinition genügt die PIN Definition
 */
...
#define LCD_DATA0_PIN    4            /**< pin for 4bit data bit 4  */
#define LCD_DATA1_PIN    5            /**< pin for 4bit data bit 5  */
#define LCD_DATA2_PIN    6            /**< pin for 4bit data bit 6  */
#define LCD_DATA3_PIN    7            /**< pin for 4bit data bit 7  */
...
/** Lese DDRAM Adresse aus LCD controller 
 @param	   keine
 @return   Adresse (Busy = 0) (Achtung inklusive Zeile nach HD44780)
*/
extern int lcd_getxy(void);

/** Makros for automatically storing string constant in program memory
*/
#define lcd_puts_P(__s)         lcd_puts_p(PSTR(__s))

/** Lese Byte aus LCD CGRAM or DDRAM
 @param		Adresse des zu lesenden Zeichens
 @return	zu lesendes Zeichen
*/
extern char lcd_read_byte(uint8_t addr);
