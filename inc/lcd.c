/****************************************************************************
 Title	:   HD44780U LCD library  V2.0
 Author:    Peter Fleury <pfleury@gmx.ch>  http://jump.to/fleury
			Ergänzung Werner Freytag	
...

{
	...
	/* Ergebnis lcd_read(rs=0) in c; c.7 AND 1 = 1, dann warten, = 0 weiter    
...
/*************************************************************************
Lese 1 Byte von vorgegebener Adresse im CGRAM oder DDRAM
Input:    DDRAM-Adresse des angeforderten Zeichens
Returns:  angefordertes Zeichen
*************************************************************************/
char lcd_read_byte(uint8_t addr)
{
